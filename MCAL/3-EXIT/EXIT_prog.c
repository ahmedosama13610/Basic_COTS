...
void EXTI_voidInit(void)
{
         ...
         SET_BIT(MCUCR,MCUCR_ISC01);
          ...
          SET_BIT(MCUCR,MCUCR_ISC01);
#else 
#error "Wrong EXTI_u8INT0_TRIG_SRC cofoguration option"
#endif		
          ...
          SET_BIT(MCUCR,MCUCR_ISC11);
#else
#error "Wrong EXTI_u8INT1_TRIG_SRC cofoguration option"
#endif
...
#else
#error "Wrong EXTI_u8INT2_TRIG_SRC cofoguration option"
#endif
...
#else
#error "Wrong EXTI_u8INT0_INIT_STATE cofoguration option"
#endif
...
#else
#error "Wrong EXTI_u8INT1_INIT_STATE cofoguration option"
#endif
...
#else
#error "Wrong EXTI_u8INT2_INIT_STATE cofoguration option"
#endif
...
uint8 EXTI_u8SetSenseCtrl(EXTI_IntNum_t copy_u8IntNum, uint8 copy_u8SenseCtrl)
{
	...
	if(copy_u8IntNum==INT0)
	{
		switch(copy_u8SenseCtrl)
		{
			...
			default : Local_u8ErrorStatem=NOK;break;
		}
	}
	...
	{
		Local_u8ErrorStatem=NOK;
	}
	return Local_u8ErrorStatem;
}
...
uint8 EXTI_u8SetCallBack(EXTI_IntNum_t copy_u8IntNum,void(*copy_pvFuncPtr)(void))
{
	...
	{
		if((copy_u8IntNum>=INT0)&&(copy_u8IntNum<=INT2))
		{
			EXTI_pfFuncPtr[copy_u8IntNum]=copy_pvFuncPtr;
		}
		else
		{
